  ...
  return (
    ...
    >
      {characters.map((char, index) => (
        ...
        >
          {char}
          {/* Fumaça individual por letra (opcional, mas o efeito global é melhor) */}
          {isVisible && (
             <span 
      ...
      {/* Nuvens de fumaça globais que surgem do canto inferior esquerdo */}
      {isVisible && (
        <div className="absolute -left-10 -bottom-10 pointer-events-none -z-10 motion-reduce:hidden">
          <div 
            className="smoke-cloud smoke-cloud-1" 
            style={{ animationDelay: `${delay}ms` }}
          />
          <div 
            className="smoke-cloud smoke-cloud-2" 
            style={{ animationDelay: `${delay + 300}ms` }}
          />
          <div 
            className="smoke-cloud smoke-cloud-3" 
