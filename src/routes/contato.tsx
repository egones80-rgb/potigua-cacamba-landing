  ...
  head: () => ({
    meta: [
      { title: "Contato | Potigua Caçamba" },
      {
        name: "description",
        content:
          "Entre em contato com a Potigua Caçamba pelo WhatsApp (11) 93309-5481 e solicite sua caçamba.",
      },
      { property: "og:title", content: "Contato | Potigua Caçamba" },
      { property: "og:description", content: "Fale com a Potigua Caçamba e solicite sua caçamba." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <>
      <PageHero
        ...
        title="Contato"
        description="Envie sua solicitação e continue a conversa direto pelo WhatsApp."
      />

      <section className="py-16 lg:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 lg:grid-cols-2 lg:px-8">
          <Reveal>
            <form onSubmit={onSubmit} noValidate className="border border-border bg-card p-6">
              ...
              <div className="mt-4">
                ...
                <input id="telefone" name="telefone" className={field} inputMode="tel" />
                {errors["telefone"] && (
